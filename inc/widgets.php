 ...
 */
add_filter('dynamic_sidebar_params', 'pentamint_wp_theme_widget_classes');

if (!function_exists('pentamint_wp_theme_widget_classes')) {
	/**
	 ...
	 * @return array $params
	 */
	function pentamint_wp_theme_widget_classes($params)
	{
...
} // endif function_exists( 'pentamint_wp_theme_widget_classes' ).
...
if (!function_exists('pentamint_wp_theme_widgets_init')) {
	...
	function pentamint_wp_theme_widgets_init() {
		...
		register_sidebar(array(
			'name'          => esc_html__('Sidebar', 'pentamint_wp_theme'),
			'id'            => 'sidebar-1',
			'description'   => esc_html__('Add widgets here.', 'pentamint_wp_theme'),
		...
		register_sidebar(array(
			'name'          => 'Top Header Left Widget', 'pentamint_wp_theme',
		...
		register_sidebar(array(
			'name'          => 'Mobile Header Widget', 'pentamint_wp_theme',
