...
if ( ! function_exists( 'pentamint_wp_theme_scripts' ) ) {
	...
	function pentamint_wp_theme_scripts() {
		...
		// Video JS Support
		wp_enqueue_style( 'videojs-css', 'https://vjs.zencdn.net/7.2.3/video-js.css', true );
		wp_enqueue_script( 'videojs-js', 'https://vjs.zencdn.net/7.2.3/video.js', array(), null, false );
		...
		wp_enqueue_script( 'theme-scripts_js', get_template_directory_uri() . '/js/theme-scripts.js', array('jquery'),  time(), true );
		/** Custom Scripts End **/
